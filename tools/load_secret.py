...
# -*- coding: utf-8 -*-
"""
[姊妹文件声明] 本文件与 DevProjectTeamSkill/tools/load_secret.py 为功能双胞胎（整改 R-2 双份保留，2026-09-05）：
  本侧 ROOT 固定为自身仓库根（git 基建单一信源）；技能库侧支持 PROJECT_ROOT 环境变量覆盖。
  除 ROOT 推导外功能必须一致，修改须双侧同步。
